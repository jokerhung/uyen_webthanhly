...
export function ItemActions({ id, status, listingOptions, initialListing, initialSalePrice = "", editor, children }: { id: string; status: ItemStatus; intakeType: IntakeType; listingOptions: ListingOptions; initialListing: ListingSelection; initialSalePrice?: string; editor?: { description: string; condition: string; salePrice: string; updatedAt: string }; children?: ReactNode }) {
