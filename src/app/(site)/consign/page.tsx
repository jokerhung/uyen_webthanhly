...
export const metadata: Metadata = { title: "Ký gửi | Besties Club", description: "Thông tin phí, tiêu chí và quy trình ký gửi trực tiếp hoặc online tại Besties Club." };
