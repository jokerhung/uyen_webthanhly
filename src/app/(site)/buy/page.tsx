...
export const metadata: Metadata = { title: "Thu mua | H.U.N", description: "Thông tin chương trình, giá thu mua và quy trình thu mua trực tiếp hoặc online tại H.U.N." };
...
export default function BuyPage() {
  return <section className="service-page buy" aria-labelledby="buy-heading"><div className="service-page__container">
    ...
    <p className="section-sub">{buyAnnouncement[0]}<br />{buyAnnouncement[1]}</p>
