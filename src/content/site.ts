...
export type SiteConfig = { readonly brand: string; readonly shopPhone: string | null; readonly minimumConsignmentItems: number | null; readonly maxImagesPerItem: number | null; readonly maxImageBytes: number | null };
