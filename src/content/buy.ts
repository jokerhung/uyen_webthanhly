...
export const buyAnnouncement = ["Liên hệ shop để xác nhận chương trình thu mua và mặt hàng đang tiếp nhận."] as const;
...
export function getBuyProcesses(shop: PublicShop): ServiceProcesses { return {
 direct: { label: "Thu Mua Trực Tiếp", note: "Vui lòng liên hệ shop trước khi mang đồ tới.", steps: [
 { text: `Gọi ${shop.phone} hoặc nhắn fanpage để được tư vấn` },
 { text: `Mang đồ tới ${shop.address} theo lịch đã thống nhất` },
